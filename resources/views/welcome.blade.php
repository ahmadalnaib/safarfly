    ...
    <div class="max-w-6xl px-10 mx-auto xl:px-5">
      ...
      <div class="flex flex-col justify-center space-y-7">
        ...
        <div class="flex flex-col w-full mx-auto space-y-5 md:space-y-0 md:space-x-5 md:flex-row">
          <input type="text" id="address" name="address"  class="flex-1 w-full px-5 py-5 text-base sm:text-lg md:text-xl lg:text-2xl xl:text-2xl  border border-gray-300 rounded-lg focus:ring-4 focus:border-red-700 focus:ring-red-600 focus:ring-opacity-50 focus:outline-none bg-gray-100 ml-5" data-primary="blue-600" data-rounded="rounded-lg" placeholder="بغداد, الرياض, دبي ..." required>
  
          <input type="date" name="start_date" value="{{date('Y-m-d')}}" class="flex-1 w-full px-5 py-5 text-base sm:text-lg md:text-xl lg:text-2xl xl:text-2xl border border-gray-300 rounded-lg focus:ring-4 focus:border-red-700 focus:ring-red-600 focus:ring-opacity-50 focus:outline-none bg-gray-100" placeholder="Start Date" required>
          <div class="flex justify-center items-center text-2xl" >
            الى
        </div>
        <input type="date" name="end_date" value="{{date('Y-m-d')}}" class="flex-1 w-full px-5 py-5 text-base sm:text-lg md:text-xl lg:text-2xl xl:text-2xl border border-gray-300 rounded-lg focus:ring-4 focus:border-red-700 focus:ring-red-600 focus:ring-opacity-50 focus:outline-none bg-gray-100" placeholder="End Date" required>
